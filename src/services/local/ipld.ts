...
export class IpldService {
  ...
  private generateCID(message: string, type: string) {
...
export const generateSha256 = async content => {
  return hexString(await digestMessage(content));
}
